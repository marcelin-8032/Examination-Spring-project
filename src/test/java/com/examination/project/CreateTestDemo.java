...
class CreateTestDemo {
    ...
    void setUp() throws ParseException {
        ...
        literature = new SubjectEntity("Literature", 175, Module.MODULE_3);
        philosophie = new SubjectEntity("Philosophie", 190, Module.MODULE_3);
        musique = new SubjectEntity("Musique", 155, Module.MODULE_3);
        DATA = new SubjectEntity("data", 200, Module.MODULE_1);
