...
class ReadTestDemo {
    ...
    void findExamsAtSpecificDate() {
       // examRepository.findExamByDateExam(examDate1).forEach(System.out::println);
    }
...
//        matiereRepository.findByCoefficientGreaterThan(180).forEach(System.out::println);
    ...
    void findExamensAtGivenSalleAndGreaterThanSpecificDate() {
        ...
        examRepository.findByRoomAndExamDateGreaterThan(roomEntity1254, examDate1).forEach(System.out::println);
        //  examenRepository.findByRoomAndExamDateGreaterThan(salle1255, examDate1).forEach(System.out::println);
        //  examenRepository.findByRoomAndExamDateGreaterThan(salle1256, examDate1).forEach(System.out::println);
    }
    ...
    void findExamensAtRecentDataAtSpecificSalle() {
        ...
        examRepository.findByRoomOrderByExamDateDesc(roomEntity1254).forEach(System.out::println);
        //  examenRepository.findByRoomOrderByExamDateDesc(salle1256).forEach(System.out::println);
    ...
    void findStudentByEachClassQueryWay() {
        studentRepository.findByClasse(Classe.classeA).forEach(System.out::println);
    }
    ...
    void findAllExamsInPageAndSorted() {
        ...
        Page<ExamEntity> examens = examRepository.findAll(page);
