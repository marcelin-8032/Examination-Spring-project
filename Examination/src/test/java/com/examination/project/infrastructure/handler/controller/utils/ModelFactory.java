...
public class ModelFactory {
    ...
    public static Set<Student> defaultStudents() {
        return List.of(defaultStudent(),
                        ...
                        defaultStudent().withStudentId(3).withFirstName("Robert").withClasse(Classe.classeC),
                        defaultStudent().withStudentId(4).withFirstName("Mickael").withClasse(Classe.classeB),
                        defaultStudent().withStudentId(5).withFirstName("Albert").withClasse(Classe.classeB),
                        defaultStudent().withStudentId(6).withFirstName("Albert").withClasse(Classe.classeB),
                        defaultStudent().withStudentId(7).withFirstName("Maria").withClasse(Classe.classeA),
                        defaultStudent().withStudentId(8).withFirstName("Natalia").withClasse(Classe.classeC))
                .toLinkedSet();
    }
